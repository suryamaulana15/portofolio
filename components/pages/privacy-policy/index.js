function PrivacyPolicy() {
  return (
    <div style={{ padding: "0px 100px" }}>
      ...
      <p>
        This Privacy Policy is prepared by PT Krealogi Inovasi Digital and whose
        registered address is Menara Cakrawala Lt. 12, Unit 1205A Jl. M. H.
        Thamrin No. 9 Kebon Sirih, Menteng Jakarta Pusat 10340 (“We”) are
        committed to protecting and preserving the privacy of our visitors when
        visiting our site or communicating electronically with us.
      </p>
      <p>
        ...
        fully with all applicable Indonesia Data Protection legislation and
      ...
      <p>
        Information you supply to us. You may supply us with information about
        you by filling in forms on our website or social media. This includes
        information you provide when you submit a contact/inquiry form. The
        information you give us may include but is not limited to, your name,
      ...
      <h3>Information you supply to us.</h3> We will use this information:
      <ul>
        <li>
      ...
      <p>
        ...
        subject access request must be made in writing to
        support@krealogi-digital.com. We will provide your personal data to you
      ...
      <p>
        ...
        welcomed and should be addressed to PT Krealogi Inovasi Digital and
